        ...
        <div v-if="showContent">
            ...
            <Card v-show="devices.length!==0" :bordered="false" dis-hover style="box-shadow: 0 0 2px 1px #eee;">
                <Row>
                    ...
                    <DatePicker style="float: right;margin-right: 20px;width: 200px;" v-model="deviceFilterDateRange" @on-change="onDateChange" type="daterange" placeholder="测试开始时间" :transfer="true" :clearable="false"></DatePicker>
                </Row>
