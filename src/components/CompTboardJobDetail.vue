<template>
    <Card :title="$t('tboardDetail.jobName')+': ' + statistic.job_name+'('+statistic.id + ')'" dis-hover>
        ...
        <Divider orientation="left">{{statistic.job_name}} {{$t('tboardDetail_2.result')}}</Divider>
        <Form :label-width="110">
            <Card v-for="statistic in deviceStatistic" :key="statistic.id" dis-hover style="margin-bottom: 16px;">
                <FormItem style="margin-bottom: 8px;">
                    <b slot="label">{{$t('tboardDetail.devName')}}:</b>
