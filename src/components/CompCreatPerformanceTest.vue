<template>
    <Card dis-hover>
        ...
        <div v-if="current===0">
            <comp-device-list ref="selectDevice" :prop-add-mode="false" :prop-device-status="true" :prop-paneview-type="true" :prop-perf-cabinet="true" :prop-high-light="true" @on-row-click="onSelectDeviceClick"></comp-device-list>
